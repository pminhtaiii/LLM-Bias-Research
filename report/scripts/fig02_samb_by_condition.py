...
values = [as_float(lookup[e]["sAMB"]) for e in EVALUATION_ORDER]
...
ax.set_xlabel(r"$s_{AMB}$")
ax.set_title("Ambiguous-context bias score by evaluation condition")
ax.invert_yaxis()
...
fig.tight_layout()
save_figure(fig, "fig02_samb_by_condition")
